...
It is very close but not identical
...
There is a greater probability that dice roll 1 = dice roll 2
...
two_roll_results <- two_roll_results %>%
  mutate(number_match = roll_1 == roll_2) %>%
  mutate(less_than_4 = roll_1 + roll_2 == 4)
